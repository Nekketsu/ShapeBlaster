...
static class Input
{
    ...
    public static bool WasButtonPressed(Buttons button) =>
        lastGamepadState.IsButtonUp(button) && gamepadState.IsButtonDown(button);
    ...
    public static Vector2 GetAimDirection()
    {
        ...
        var direction = gamepadState.ThumbSticks.Right;
        direction.Y *= -1;
    ...
    public static bool WasBombButtonPressed() =>
        WasButtonPressed(Buttons.LeftTrigger) || WasButtonPressed(Buttons.RightTrigger) || WasKeyPressed(Keys.Space);
}