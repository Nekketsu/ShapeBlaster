    ...
    public void Draw(SpriteBatch spriteBatch)
    {
        ...
        for (var y = 1; y < height; y++)
        {
            for (var x = 1; x < width; x++)
            {
                ...
                var up = new Vector2();
                var p = ToVec2(points[x, y].Position);
                if (x > 1)
                {
                    ...
                    var mid = Vector2.CatmullRom(ToVec2(points[x - 2, y].Position), left, p, ToVec2(points[clampedX, y].Position), 0.5f);
                ...
                if (y > 1)
                {
                    ...
                    var mid = Vector2.CatmullRom(ToVec2(points[x, y - 2].Position), up, p, ToVec2(points[x, clampedY].Position), 0.5f);
                ...
                if (x > 1 && y > 1)
                {
                    var upLeft = ToVec2(points[x - 1, y - 1].Position);
